...
app.get('/puppies', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const puppies = yield Puppy.find();
    res.send(puppies);
}));
app.get('/puppies/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const puppy = yield Puppy.findById(req.params.id);
    res.send(puppy);
}));
app.post('/puppies', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const puppy = new Puppy(req.body);
    yield puppy.save();
    res.send(puppy);
}));
app.put('/puppies/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const puppy = yield Puppy.findByIdAndUpdate(req.params.id, req.body);
    yield puppy.save();
    res.send(puppy);
}));
app.delete('/puppies/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
